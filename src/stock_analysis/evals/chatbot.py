"""Chatbot evaluations for stock analysis agent."""
...
async def eval_chatbot(agent: ChatAgent, tools: list[BaseTool] | None = None) -> None:
    """Evaluate the chatbot performance of the stock analysis agent.
    ...
    dataset: EvaluationDataset = load_dataset(dataset_dir / "chatbot.json")
