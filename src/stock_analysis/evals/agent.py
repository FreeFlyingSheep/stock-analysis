"""Agent evaluations for stock analysis agent."""
...
async def eval_agent(agent: ChatAgent, tools: list[BaseTool] | None = None) -> None:
    """Evaluate end-to-end analysis quality of the stock analysis agent.
    ...
    dataset: EvaluationDataset = load_dataset(dataset_dir / "agent.json")
    ...
    metrics: list[BaseMetric] = [answer_relevancy, task_completion]
